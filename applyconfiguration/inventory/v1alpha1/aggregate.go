...
type AggregateApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *inventoryv1alpha1.AggregateStatus `json:"status,omitempty"`
}
...
// Experimental!
func ExtractAggregate(aggregate *inventoryv1alpha1.Aggregate, fieldManager string) (*AggregateApplyConfiguration, error) {
...
// Experimental!
func ExtractAggregateStatus(aggregate *inventoryv1alpha1.Aggregate, fieldManager string) (*AggregateApplyConfiguration, error) {
	return extractAggregate(aggregate, fieldManager, "status")
}

func extractAggregate(aggregate *inventoryv1alpha1.Aggregate, fieldManager string, subresource string) (*AggregateApplyConfiguration, error) {
	b := &AggregateApplyConfiguration{}
	err := managedfields.ExtractInto(aggregate, internal.Parser().Type("com.github.onmetal.metal-api.apis.inventory.v1alpha1.Aggregate"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *AggregateApplyConfiguration) WithStatus(value inventoryv1alpha1.AggregateStatus) *AggregateApplyConfiguration {
	b.Status = &value
	return b
}
