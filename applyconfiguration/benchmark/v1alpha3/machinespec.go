...
type MachineSpecApplyConfiguration struct {
	Benchmarks map[string]v1alpha3.Benchmarks `json:"benchmarks,omitempty"`
}
...
func (b *MachineSpecApplyConfiguration) WithBenchmarks(entries map[string]v1alpha3.Benchmarks) *MachineSpecApplyConfiguration {
	if b.Benchmarks == nil && len(entries) > 0 {
		b.Benchmarks = make(map[string]v1alpha3.Benchmarks, len(entries))
	}
