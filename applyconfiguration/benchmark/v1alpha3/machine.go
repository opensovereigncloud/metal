...
func Machine(name, namespace string) *MachineApplyConfiguration {
	...
	b.WithKind("Machine")
	b.WithAPIVersion("benchmark.onmetal.de/v1alpha3")
	return b
}
...
// Experimental!
func ExtractMachine(machine *benchmarkv1alpha3.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
...
// Experimental!
func ExtractMachineStatus(machine *benchmarkv1alpha3.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
	return extractMachine(machine, fieldManager, "status")
}

func extractMachine(machine *benchmarkv1alpha3.Machine, fieldManager string, subresource string) (*MachineApplyConfiguration, error) {
	b := &MachineApplyConfiguration{}
	err := managedfields.ExtractInto(machine, internal.Parser().Type("com.github.onmetal.metal-api.apis.benchmark.v1alpha3.Machine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
