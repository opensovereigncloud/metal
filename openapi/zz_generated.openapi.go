...
func schema_metal_apis_metal_v1alpha4_FieldSelectorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "FieldSelectorSpec contains label key and field path where to get label value for search",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"labelKey": {
						SchemaProps: spec.SchemaProps{
					...
					"fieldRef": {
						SchemaProps: spec.SchemaProps{
							Description: "FieldRef contains reference to the field of resource where to get label's value",
							Ref:         ref("k8s.io/api/core/v1.ObjectFieldSelector"),
						},
					},
				},
				Required: []string{"labelKey", "fieldRef"},
			},
		},
		Dependencies: []string{
...
func schema_metal_apis_metal_v1alpha4_GeneralIPAMSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GeneralIPAMSpec contains definition of selectors, used to filter required IPAM objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"addressFamily": {
						SchemaProps: spec.SchemaProps{
				...
				Required: []string{"addressFamily", "carrierSubnets", "loopbackSubnets"},
			},
		},
		Dependencies: []string{
...
func schema_metal_apis_metal_v1alpha4_IPAMSelectionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IPAMSelectionSpec contains label selector and address family",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"labelSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "LabelSelector contains label selector to pick up IPAM objects",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector"),
						},
					},
					"fieldSelector": {
...
func schema_metal_apis_metal_v1alpha4_IPAMSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IPAMSpec contains selectors for subnets and loopback IPs and definition of address families which should be claimed",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"southSubnets": {
						SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"namespace": {
						SchemaProps: spec.SchemaProps{
							Description: "Namespace contains namespace of the referenced object",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"extraAddress": {
						SchemaProps: spec.SchemaProps{
							Description: "ExtraAddress is a flag defining whether address was added as additional by user",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
...
func schema_metal_apis_metal_v1alpha4_InterfaceOverridesSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "InterfaceOverridesSpec contains overridden parameters for certain switch port",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"lanes": {
						SchemaProps: spec.SchemaProps{
							Description: "Lanes refers to a number of lanes used by switch port",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"mtu": {
						SchemaProps: spec.SchemaProps{
							Description: "MTU refers to maximum transmission unit value which should be applied on switch port",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"ipv4MaskLength": {
						SchemaProps: spec.SchemaProps{
							Description: "IPv4MaskLength defines prefix of subnet where switch port's IPv4 address should be reserved",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"ipv6Prefix": {
						SchemaProps: spec.SchemaProps{
							Description: "IPv6Prefix defines prefix of subnet where switch port's IPv6 address should be reserved",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"fec": {
						SchemaProps: spec.SchemaProps{
							Description: "FEC refers to forward error correction method which should be applied on switch port",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"ip": {
						SchemaProps: spec.SchemaProps{
							Description: "IP contains a list of additional IP addresses for interface",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"macAddress": {
						SchemaProps: spec.SchemaProps{
							Description: "MACAddress refers to the interface's hardware address validation pattern",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"ip": {
						SchemaProps: spec.SchemaProps{
							Description: "IP contains a list of IP addresses that are assigned to interface",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"direction": {
						SchemaProps: spec.SchemaProps{
							Description: "Direction refers to the interface's connection 'direction'",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				...
				Required: []string{"macAddress", "speed", "direction"},
			},
		},
		Dependencies: []string{
...
func schema_metal_apis_metal_v1alpha4_InterfacesSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "InterfacesSpec contains definitions for general switch ports' configuration",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"defaults": {
						SchemaProps: spec.SchemaProps{
					...
					"overrides": {
						SchemaProps: spec.SchemaProps{
							Description: "Overrides contains set of parameters which should be overridden for listed switch ports",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_metal_apis_metal_v1alpha4_ObjectReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ObjectReference contains enough information to let you locate the referenced object across namespaces.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
...
func schema_metal_apis_metal_v1alpha4_PeerInfoSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PeerInfoSpec contains LLDP info about peer",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"chassisId": {
						SchemaProps: spec.SchemaProps{
							Description: "ChassisID refers to the chassis identificator - either MAC-address or system uuid validation pattern",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"systemName": {
						SchemaProps: spec.SchemaProps{
							Description: "SystemName refers to the advertised peer's name",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"portId": {
						SchemaProps: spec.SchemaProps{
							Description: "PortID refers to the advertised peer's port ID",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"portDescription": {
						SchemaProps: spec.SchemaProps{
							Description: "PortDescription refers to the advertised peer's port description",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_metal_apis_metal_v1alpha4_PeerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PeerSpec defines peer info",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
...
func schema_metal_apis_metal_v1alpha4_PortParametersSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PortParametersSpec contains a set of parameters of switch port",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"lanes": {
						SchemaProps: spec.SchemaProps{
...
func schema_metal_apis_metal_v1alpha4_RegionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RegionSpec defines region info",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
					...
					"availabilityZone": {
						SchemaProps: spec.SchemaProps{
							Description: "AvailabilityZone refers to the switch's availability zone",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"name", "availabilityZone"},
			},
		},
	}
}
...
func schema_metal_apis_metal_v1alpha4_SwitchConfigList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SwitchConfigList contains a list of SwitchConfig.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_metal_apis_metal_v1alpha4_SwitchConfigSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SwitchConfigSpec contains desired configuration for selected switches.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"switches": {
						SchemaProps: spec.SchemaProps{
					...
					"routingConfigTemplate": {
						SchemaProps: spec.SchemaProps{
							Description: "RoutingConfigTemplate contains the reference to the ConfigMap object which contains go-template for FRR config",
							Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
						},
					},
				},
				Required: []string{"portsDefaults", "ipam"},
			},
		},
		Dependencies: []string{
