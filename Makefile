...
# Private Gardener Onmetal repos
...
test: manifests generate fmt vet ## Run tests.
	...
	source ${ENVTEST_ASSETS_DIR}/setup-envtest.sh; fetch_envtest_tools $(ENVTEST_ASSETS_DIR); setup_envtest_env $(ENVTEST_ASSETS_DIR); go test ./api/v1alpha1/... -coverprofile cover.out; go test ./controllers/... -coverprofile cover.out; go test -coverpkg=./...  -coverprofile cover.out ./tests/...
