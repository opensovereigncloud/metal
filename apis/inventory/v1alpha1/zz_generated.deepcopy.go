...
func (in *BenchmarkSpec) DeepCopyInto(out *BenchmarkSpec) {
	*out = *in
	if in.Blocks != nil {
		...
		*out = make([]BlockBenchmarkCollection, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BlockBenchmarkCollection) DeepCopyInto(out *BlockBenchmarkCollection) {
	*out = *in
	if in.Results != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BlockBenchmarkCollection.
func (in *BlockBenchmarkCollection) DeepCopy() *BlockBenchmarkCollection {
	if in == nil {
		return nil
	}
	out := new(BlockBenchmarkCollection)
	in.DeepCopyInto(out)
	return out
}
