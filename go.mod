...
require (
	...
	github.com/onmetal/ipam v0.0.16
	github.com/onmetal/oob-operator v0.0.0-20230119152712-d6e69fc047a5
...
// according to https://github.com/kubernetes/kubernetes/issues/79384
replace (
