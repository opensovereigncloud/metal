...
type OrderAlreadyScheduledUseCase struct {
	orderAlreadyScheduled domain.OrderAlreadyScheduled
}

func NewOrderAlreadyScheduledUseCase(orderAlreadyScheduled domain.OrderAlreadyScheduled) *OrderAlreadyScheduledUseCase {
	return &OrderAlreadyScheduledUseCase{
