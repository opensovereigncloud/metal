...
// OOBApplyConfiguration represents an declarative configuration of the OOB type for use
// with apply.
...
// OOB constructs an declarative configuration of the OOB type for use with
// apply.
...
// ExtractOOB extracts the applied configuration owned by fieldManager from
// oOB. If no managedFields are found in oOB for fieldManager, a
// OOBApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// oOB must be a unmodified OOB API object that was retrieved from the Kubernetes API.
// ExtractOOB provides a way to perform a extract/modify-in-place/apply workflow.
...
func ExtractOOB(oOB *apiv1alpha1.OOB, fieldManager string) (*OOBApplyConfiguration, error) {
	return extractOOB(oOB, fieldManager, "")
}

// ExtractOOBStatus is the same as ExtractOOB except
// that it extracts the status subresource applied configuration.
// Experimental!
func ExtractOOBStatus(oOB *apiv1alpha1.OOB, fieldManager string) (*OOBApplyConfiguration, error) {
	return extractOOB(oOB, fieldManager, "status")
}

func extractOOB(oOB *apiv1alpha1.OOB, fieldManager string, subresource string) (*OOBApplyConfiguration, error) {
	b := &OOBApplyConfiguration{}
	err := managedfields.ExtractInto(oOB, internal.Parser().Type("com.github.ironcore-dev.metal.api.v1alpha1.OOB"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(oOB.Name)
	b.WithNamespace(oOB.Namespace)
...
func (b *OOBApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
