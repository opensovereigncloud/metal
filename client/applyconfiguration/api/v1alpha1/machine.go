...
// MachineApplyConfiguration represents an declarative configuration of the Machine type for use
// with apply.
...
// Machine constructs an declarative configuration of the Machine type for use with
// apply.
...
// Experimental!
func ExtractMachine(machine *apiv1alpha1.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
...
// Experimental!
func ExtractMachineStatus(machine *apiv1alpha1.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
	return extractMachine(machine, fieldManager, "status")
}

func extractMachine(machine *apiv1alpha1.Machine, fieldManager string, subresource string) (*MachineApplyConfiguration, error) {
	b := &MachineApplyConfiguration{}
	err := managedfields.ExtractInto(machine, internal.Parser().Type("com.github.ironcore-dev.metal.api.v1alpha1.Machine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
