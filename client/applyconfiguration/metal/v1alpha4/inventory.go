...
func extractInventory(inventory *metalv1alpha4.Inventory, fieldManager string, subresource string) (*InventoryApplyConfiguration, error) {
	b := &InventoryApplyConfiguration{}
	err := managedfields.ExtractInto(inventory, internal.Parser().Type("com.github.ironcore-dev.metal.apis.metal.v1alpha4.Inventory"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
