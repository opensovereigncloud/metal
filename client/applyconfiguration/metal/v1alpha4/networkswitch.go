...
// NetworkSwitchApplyConfiguration represents an declarative configuration of the NetworkSwitch type for use
// with apply.
...
// NetworkSwitch constructs an declarative configuration of the NetworkSwitch type for use with
// apply.
func NetworkSwitch(name, namespace string) *NetworkSwitchApplyConfiguration {
	b := &NetworkSwitchApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("NetworkSwitch")
	b.WithAPIVersion("metal.ironcore.dev/v1alpha4")
	return b
}

// ExtractNetworkSwitch extracts the applied configuration owned by fieldManager from
// networkSwitch. If no managedFields are found in networkSwitch for fieldManager, a
// NetworkSwitchApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// networkSwitch must be a unmodified NetworkSwitch API object that was retrieved from the Kubernetes API.
// ExtractNetworkSwitch provides a way to perform a extract/modify-in-place/apply workflow.
...
func ExtractNetworkSwitch(networkSwitch *metalv1alpha4.NetworkSwitch, fieldManager string) (*NetworkSwitchApplyConfiguration, error) {
	return extractNetworkSwitch(networkSwitch, fieldManager, "")
}

// ExtractNetworkSwitchStatus is the same as ExtractNetworkSwitch except
...
func ExtractNetworkSwitchStatus(networkSwitch *metalv1alpha4.NetworkSwitch, fieldManager string) (*NetworkSwitchApplyConfiguration, error) {
	return extractNetworkSwitch(networkSwitch, fieldManager, "status")
}

func extractNetworkSwitch(networkSwitch *metalv1alpha4.NetworkSwitch, fieldManager string, subresource string) (*NetworkSwitchApplyConfiguration, error) {
	b := &NetworkSwitchApplyConfiguration{}
	err := managedfields.ExtractInto(networkSwitch, internal.Parser().Type("com.github.ironcore-dev.metal.apis.metal.v1alpha4.NetworkSwitch"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(networkSwitch.Name)
	b.WithNamespace(networkSwitch.Namespace)
...
func (b *NetworkSwitchApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
