...
func extractMachine(machine *metalv1alpha4.Machine, fieldManager string, subresource string) (*MachineApplyConfiguration, error) {
	b := &MachineApplyConfiguration{}
	err := managedfields.ExtractInto(machine, internal.Parser().Type("com.github.ironcore-dev.metal.apis.metal.v1alpha4.Machine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
