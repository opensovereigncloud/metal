...
var machinesResource = v1alpha4.SchemeGroupVersion.WithResource("machines")

var machinesKind = v1alpha4.SchemeGroupVersion.WithKind("Machine")
...
func (c *FakeMachines) Apply(ctx context.Context, machine *metalv1alpha4.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha4.Machine, err error) {
	if machine == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(machinesResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha4.Machine{})
...
func (c *FakeMachines) ApplyStatus(ctx context.Context, machine *metalv1alpha4.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha4.Machine, err error) {
	if machine == nil {
		return nil, fmt.Errorf("machine provided to Apply must not be nil")
	}
	data, err := json.Marshal(machine)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(machinesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha4.Machine{})
