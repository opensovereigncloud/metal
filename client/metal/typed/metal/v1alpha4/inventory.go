...
func newInventories(c *MetalV1alpha4Client, namespace string) *inventories {
	return &inventories{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *inventories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha4.Inventory, err error) {
	result = &v1alpha4.Inventory{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *inventories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha4.InventoryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha4.InventoryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("inventories").
...
func (c *inventories) Create(ctx context.Context, inventory *v1alpha4.Inventory, opts v1.CreateOptions) (result *v1alpha4.Inventory, err error) {
	result = &v1alpha4.Inventory{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("inventories").
...
func (c *inventories) Update(ctx context.Context, inventory *v1alpha4.Inventory, opts v1.UpdateOptions) (result *v1alpha4.Inventory, err error) {
	result = &v1alpha4.Inventory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("inventories").
...
func (c *inventories) UpdateStatus(ctx context.Context, inventory *v1alpha4.Inventory, opts v1.UpdateOptions) (result *v1alpha4.Inventory, err error) {
	result = &v1alpha4.Inventory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("inventories").
...
func (c *inventories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha4.Inventory, err error) {
	result = &v1alpha4.Inventory{}
...
func (c *inventories) Apply(ctx context.Context, inventory *metalv1alpha4.InventoryApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha4.Inventory, err error) {
	if inventory == nil {
...
func (c *inventories) ApplyStatus(ctx context.Context, inventory *metalv1alpha4.InventoryApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha4.Inventory, err error) {
	if inventory == nil {
		return nil, fmt.Errorf("inventory provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
