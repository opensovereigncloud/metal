...
func newMachines(c *MetalV1alpha4Client, namespace string) *machines {
	return &machines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *machines) Apply(ctx context.Context, machine *metalv1alpha4.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha4.Machine, err error) {
	if machine == nil {
...
func (c *machines) ApplyStatus(ctx context.Context, machine *metalv1alpha4.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha4.Machine, err error) {
	if machine == nil {
		return nil, fmt.Errorf("machine provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
