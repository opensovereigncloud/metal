...
//
//	deviceOnboardingRepo := kubernetes.NewOnboardingRepo(k8sManager.GetClient())
//	deviceOnboardingUseCase := scenarios.NewDeviceOnboarding(deviceOnboardingRepo)
//
//	err = (&OnboardingMachineReconciler{
//		Client:               k8sManager.GetClient(),
//		log:                  ctrl.log.WithName("controllers").WithName("device-onboarding"),
//		getMachineUseCase:    deviceOnboardingUseCase,
